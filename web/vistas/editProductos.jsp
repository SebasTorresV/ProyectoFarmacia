                ...
                <div class="form-container">
                    ...
                    <form action="ControladorProductos" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" id="txtNombre" name="txtNombre" value="<%= pro.getNombre() %>">
                        </div>
                        <div class="mb-3">
                            <label for="txtPrecio" class="form-label">Precio:</label>
                            <input class="form-control" type="text" id="txtPrecio" name="txtPrecio" value="<%= pro.getPrecio() %>">
                        </div>
                        <div class="mb-3">
                            <label for="txtStock" class="form-label">Stock:</label>
                            <input class="form-control" type="text" id="txtStock" name="txtStock" value="<%= pro.getStock() %>">
                        </div>
                        <div class="mb-3">
                            <label for="txtDescripcion" class="form-label">Descripción:</label>
                            <input class="form-control" type="text" id="txtDescripcion" name="txtDescripcion" value="<%= pro.getDescripcion() %>">
                        </div>
                        <div class="text-center">
                            <button class="btn btn-primary" type="submit" name="accion" value="updateProducto">Actualizar Producto</button>
                        </div>
                    </form>
                    <div class="text-center mt-3">
                        <a class="btn btn-secondary" href="ControladorProductos?accion=listarProductos">Regresar</a>
                    </div>
                </div>
            </div>
        </div>
